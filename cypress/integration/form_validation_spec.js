...
describe('Form Validations', () => {
  it('Checks all fields are required and validates email and password', () => {
    cy.visit('https://dev-fe.buttonshift.com', { timeout: 30000 }); // Increase visit timeout

    // Ensure 'Signup' button is visible before clicking
    cy.contains('Signup', { timeout: 10000 }).should('be.visible').click();
